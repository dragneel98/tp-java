...
import com.example.entidades.HomeSolution;
import com.example.entidades.IHomeSolution;
import com.example.entidades.Tupla;
...
public class HomeSolutionTest {
    ...
    public void testCalculaCostoConRetrasosCorrectamente() throws Exception {
        ...
        System.out.println(calculoCostoConRetraso());
    ...
    private double calcularCosto() {
        double costo = 0;
        costo = 15000 * 32;// 480.000
        costo += 80000 * 2 * 1.02;// 166.400
        costo += 15000 * 8;// 120.000
        costo += 50000 * 1 * 1.02;// 51.000
        return costo;
    }
